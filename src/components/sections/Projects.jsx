...
export default function Projects() {
    ...
    return (
        <section
            id="projects"
            className="min-h-screen grid-design py-8 sm:py-10 lg:py-20 pt-18"
        >
                ...
                {projects.map((project, index) => {
                    ...
                    return (
                        <motion.div
                            ...
                            whileInView="visible"
                            viewport={{ once: true }}
                            className={`border border-text-muted sm:flex ${isEven ? "sm:flex-row" : "sm:flex-row-reverse"
                                }`}
                        >
                            <motion.div
                                variants={fadeUp}
                                className="p-4 bg-text-muted/10 sm:flex-1 sm:flex sm:justify-center 2xl:max-w-200"
                            >
                                <img
                                    src={project.imgUrl}
                                    alt=""
